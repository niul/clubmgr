			...
			<div class="row">
				...
				<div class="4u 12u$(medium) 12u$(small)">
					...
					<section class="widget contact last">
						...
						<ul>
  							<li><a href="<f:message key='footer.social.facebook.url'/>" title="<f:message key='footer.social.facebook.url'/>" target="_blank"><img src="static/images/social/blue/facebook-logo-square.png" height="64" width="64"></a></li>
  							<li><a href="<f:message key='footer.social.twitter.url'/>"  title="<f:message key='footer.social.twitter.url'/>" target="_blank"><img src="static/images/social/blue/twitter-logo-square.png" height="64" width="64"></a></li>
  							<li><a href="<f:message key='footer.social.google_plus.url'/>" title="<f:message key='footer.social.google_plus.url'/>" target="_blank"><img src="static/images/social/blue/google-logo-square.png" height="64" width="64"></a></li>
  							<li><a href="<f:message key='footer.social.wordpress.url'/>" title="<f:message key='footer.social.wordpress.url'/>" target="_blank"><img src="static/images/social/blue/wordpress-logo-square.png" height="64" width="64"></a></li>
						</ul>
					</section>
				</div>
			</div>
