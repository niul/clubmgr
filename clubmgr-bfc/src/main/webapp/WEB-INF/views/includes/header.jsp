<%@ include file="/WEB-INF/views/taglibs.jsp" %>
	...
	<div id="header-wrapper">
		<header id="header" class="container">
			<!-- Logo -->
			<div id="logo" >
				<a href="index.html"><img id="header_logo" border="0" alt="bombastic fc" src="static/images/bombasticfc_logo.png" width="160" height="160"></a>
			...
			<div class="row">
      			<div class="2u -10u 12u$(medium) 12u$(small)">
					...
					<ul class="share-buttons">
  						...
  						<li><a href="https://twitter.com/intent/tweet?source=${cf:urlEncode(url)}&text=:%20${cf:urlEncode(url)}&via=bombasticfc" target="_blank" title="Tweet" onclick="window.open('https://twitter.com/intent/tweet?text=' + encodeURIComponent(document.title) + ':%20'  + encodeURIComponent(${url})); return false;"><img src="static/images/social/share/Twitter.png"></a></li>
  						<li><a href="https://plus.google.com/share?url=${cf:urlEncode(url)}" target="_blank" title="Share on Google+" onclick="window.open('https://plus.google.com/share?url=' + encodeURIComponent(${url})); return false;"><img src="static/images/social/share/Google+.png"></a></li>
  						<li><a href="http://wordpress.com/press-this.php?u=${cf:urlEncode(url)}&t=&s=" target="_blank" title="Publish on WordPress" onclick="window.open('http://wordpress.com/press-this.php?u=' + encodeURIComponent(${url}) + '&t=' +  encodeURIComponent(document.title)); return false;"><img src="static/images/social/share/Wordpress.png"></a></li>
					</ul>
				</div>
			</div>
		</header>
