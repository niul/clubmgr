...
public class VMSLDataManagerTest {
	...
	public void createDataManagerTest() {
		DataManager dataManager = dataManagerFactory.createDataManager("BOMBASTIC_MENS_A", "WINTER_2016");
	...
	public void vmslUpdateFixturesTest() {
		...
		dataManager = dataManagerFactory.createDataManager("BOMBASTIC_MENS_B", "WINTER_2016");
		fixtures = dataManager.updateFixtures();
		dataManager = dataManagerFactory.createDataManager("BOMBASTIC_MENS_CLASSICS", "WINTER_2016");
		fixtures = dataManager.updateFixtures();
	...
	public void vmslUpdateStandingsTest() {
		...
		dataManager = dataManagerFactory.createDataManager("BOMBASTIC_MENS_CLASSICS", "WINTER_2016");
		fixtures = dataManager.updateStandings();
		dataManager = dataManagerFactory.createDataManager("BOMBASTIC_MENS_JURASSIC", "WINTER_2016");
		fixtures = dataManager.updateStandings();
		assertNotNull(fixtures);
	}
}
