...
/** CLUBS */
INSERT INTO clubs (name, uuid, club_key, created)
VALUES    ('Bombastic FC', uuid_generate_v4(), 'BOMBASTIC', CURRENT_TIMESTAMP);


/** TEAMS */
INSERT INTO teams (club_id, uuid, name, team_key, created) (
    SELECT    club_id, uuid_generate_v4(), 'Mens A', 'BOMBASTIC_MENS_A', CURRENT_TIMESTAMP
    FROM    clubs WHERE club_key = 'BOMBASTIC'
);

INSERT INTO teams (club_id, uuid, name, team_key, created) (
    SELECT    club_id, uuid_generate_v4(), 'Mens B', 'BOMBASTIC_MENS_B', CURRENT_TIMESTAMP
    FROM    clubs WHERE club_key = 'BOMBASTIC'
);

INSERT INTO teams (club_id, uuid, name, team_key, created) (
    SELECT    club_id, uuid_generate_v4(), 'Mens Classics', 'BOMBASTIC_MENS_CLASSICS', CURRENT_TIMESTAMP
    FROM    clubs WHERE club_key = 'BOMBASTIC'
);

INSERT INTO teams (club_id, uuid, name, team_key, created) (
    SELECT    club_id, uuid_generate_v4(), 'Mens Jurassic', 'BOMBASTIC_MENS_JURASSIC', CURRENT_TIMESTAMP
    FROM    clubs WHERE club_key = 'BOMBASTIC'
);

INSERT INTO teams (club_id, uuid, name, team_key, created) (
    SELECT    club_id, uuid_generate_v4(), 'Womens', 'BOMBASTIC_WOMENS', CURRENT_TIMESTAMP
    FROM    clubs WHERE club_key = 'BOMBASTIC'
);
...
INSERT INTO standings (team_id, uuid, season_id, position, team, gamesPlayed, wins, ties, losses, goalsFor, goalsAgainst, points, created) (
    SELECT    team_id, uuid_generate_v4(), season_id, 1, 'Rinos Fury A', 7, 6, 1, 0, 15, 6, 19, CURRENT_TIMESTAMP
    FROM    teams T
...
INSERT INTO standings (team_id, uuid, season_id, position, team, gamesPlayed, wins, ties, losses, goalsFor, goalsAgainst, points, created) (
    SELECT    team_id, uuid_generate_v4(), season_id, 2, 'Gastown FC', 7, 4, 1, 2, 14, 12, 13, CURRENT_TIMESTAMP
    FROM    teams T
    JOIN    seasons S ON S.season_key = 'WINTER_2015'
    WHERE    T.team_key = 'BOMBASTIC_MENS_A'
);
...
INSERT INTO standings (team_id, uuid, season_id, position, team, gamesPlayed, wins, ties, losses, goalsFor, goalsAgainst, points, created) (
    SELECT    team_id, uuid_generate_v4(), season_id, 3, 'Vancouver Strikers', 6, 4, 1, 1, 12, 7, 13, CURRENT_TIMESTAMP
    FROM    teams T
    JOIN    seasons S ON S.season_key = 'WINTER_2015'
    WHERE    T.team_key = 'BOMBASTIC_MENS_A'
);
...
INSERT INTO standings (team_id, uuid, season_id, position, team, gamesPlayed, wins, ties, losses, goalsFor, goalsAgainst, points, created) (
    SELECT    team_id, uuid_generate_v4(), season_id, 4, 'HK Hrvat A', 7, 4, 0, 3, 12, 10, 12, CURRENT_TIMESTAMP
    FROM    teams T
    JOIN    seasons S ON S.season_key = 'WINTER_2015'
    WHERE    T.team_key = 'BOMBASTIC_MENS_A'
);
...
INSERT INTO standings (team_id, uuid, season_id, position, team, gamesPlayed, wins, ties, losses, goalsFor, goalsAgainst, points, created) (
    SELECT    team_id, uuid_generate_v4(), season_id, 5, 'Harps FC A', 7, 3, 2, 2, 13, 9, 11, CURRENT_TIMESTAMP
    FROM    teams T
    JOIN    seasons S ON S.season_key = 'WINTER_2015'
    WHERE    T.team_key = 'BOMBASTIC_MENS_A'
);
...
INSERT INTO standings (team_id, uuid, season_id, position, team, gamesPlayed, wins, ties, losses, goalsFor, goalsAgainst, points, created) (
    SELECT    team_id, uuid_generate_v4(), season_id, 6, 'Bombastic FC A', 7, 3, 1, 3, 11, 11, 10, CURRENT_TIMESTAMP
    FROM    teams T
    JOIN    seasons S ON S.season_key = 'WINTER_2015'
    WHERE    T.team_key = 'BOMBASTIC_MENS_A'
);
...
INSERT INTO standings (team_id, uuid, season_id, position, team, gamesPlayed, wins, ties, losses, goalsFor, goalsAgainst, points, created) (
    SELECT    team_id, uuid_generate_v4(), season_id, 7, 'Squamish FC', 6, 3, 1, 2, 19, 9, 10, CURRENT_TIMESTAMP
    FROM    teams T
    JOIN    seasons S ON S.season_key = 'WINTER_2015'
    WHERE    T.team_key = 'BOMBASTIC_MENS_A'
);
...
INSERT INTO standings (team_id, uuid, season_id, position, team, gamesPlayed, wins, ties, losses, goalsFor, goalsAgainst, points, created) (
    SELECT    team_id, uuid_generate_v4(), season_id, 8, 'Euro FC', 7, 2, 2, 3, 6, 9, 8, CURRENT_TIMESTAMP
    FROM    teams T
    JOIN    seasons S ON S.season_key = 'WINTER_2015'
    WHERE    T.team_key = 'BOMBASTIC_MENS_A'
);
...
INSERT INTO standings (team_id, uuid, season_id, position, team, gamesPlayed, wins, ties, losses, goalsFor, goalsAgainst, points, created) (
    SELECT    team_id, uuid_generate_v4(), season_id, 9, 'Vancouver United FC', 7, 2, 2, 3, 11, 13, 8, CURRENT_TIMESTAMP
    FROM    teams T
    JOIN    seasons S ON S.season_key = 'WINTER_2015'
    WHERE    T.team_key = 'BOMBASTIC_MENS_A'
);
...
INSERT INTO standings (team_id, uuid, season_id, position, team, gamesPlayed, wins, ties, losses, goalsFor, goalsAgainst, points, created) (
    SELECT    team_id, uuid_generate_v4(), season_id, 10, '13th Legion FC', 7, 1, 3, 3, 6, 10, 6, CURRENT_TIMESTAMP
    FROM    teams T
    JOIN    seasons S ON S.season_key = 'WINTER_2015'
    WHERE    T.team_key = 'BOMBASTIC_MENS_A'
);
...
INSERT INTO standings (team_id, uuid, season_id, position, team, gamesPlayed, wins, ties, losses, goalsFor, goalsAgainst, points, created) (
    SELECT    team_id, uuid_generate_v4(), season_id, 11, 'GFC United Lions', 7, 1, 1, 5, 8, 21, 4, CURRENT_TIMESTAMP
    FROM    teams T
    JOIN    seasons S ON S.season_key = 'WINTER_2015'
    WHERE    T.team_key = 'BOMBASTIC_MENS_A'
);
...
INSERT INTO standings (team_id, uuid, season_id, position, team, gamesPlayed, wins, ties, losses, goalsFor, goalsAgainst, points, created) (
    SELECT    team_id, uuid_generate_v4(), season_id, 12, 'America FC', 7, 0, 1, 6, 6, 16, 1, CURRENT_TIMESTAMP
    FROM    teams T
    JOIN    seasons S ON S.season_key = 'WINTER_2015'
    WHERE    T.team_key = 'BOMBASTIC_MENS_A'
);
